    ...
    <div class="man_box">
        <div class="man_container">
            <div class="man_inner">
                <div class="man_top">
                    <h1>대여페이지</h1>
                    <p>현재 대여 중인 도서 목록입니다.</p>
                </div>
                <div>
                    <nav>
                      <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">대여목록</button>
                      </div>
                    </nav>
                            ...
                            <c:forEach var="book" items="${books}">
                                <c:if test="${!book.borrowed}">
                                    <li class="prod_item" id="book-item-${book.id}" data-book-id="${book.id}">
                                        ...
                                        <div class="prod_btn">
                                            <!-- HTML 버튼 예시 -->
                                            <button type="button" data-book-id="${book.id}" class="btn btn-dark return-btn" onclick="burrowBook(${book.id})">대여</button>
